...
<p align="center">
  <img src="assets/paper-preview.png" alt="SnowMaster-Unofficial paper or project page preview" width="900">
</p>
...
| Item | Details |
|---|---|
| Paper | SnowMaster: Comprehensive Real-world Image Desnowing via MLLM with Multi-Model Feedback Optimization |
| Venue / Source | CVPR 2025 |
| Focus | This repository organizes a PyTorch implementation for SnowMaster: Comprehensive Real-world Image Desnowing via MLLM with Multi-Model Feedback Optimization, focusing on real-wor... |
